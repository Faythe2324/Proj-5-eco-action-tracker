...
Abigail Kaye Duarte	--> Backend & Database Developer — Implemented SQLite data handling, structured database schema, managed data persistence and CRUD operations.
